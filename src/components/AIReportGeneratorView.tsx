...
export const AIReportGeneratorView: React.FC<AIReportGeneratorViewProps> = ({ reportData }) => {
  ...
  const handlePrintCompanyStandardPdf = () => {
    ...
    openStandardPDReportPrintWindow({
      ...
      coApplicants: [{ name: 'Mrs. Rubi Devi', relation: 'Spouse', mobileNumber: '8252240942' }],
      ...
      // Financial Waterfall
      totalSalesMonthly: fin.adoptedRevenue || 91000,
      totalSalesYearly: (fin.adoptedRevenue || 91000) * 12,
      totalExpensesMonthly: fin.totalOperatingExpenses || 76200,
      totalExpensesYearly: (fin.totalOperatingExpenses || 76200) * 12,
      netProfitMonthly: fin.netBusinessIncome || 14800,
      netProfitYearly: (fin.netBusinessIncome || 14800) * 12,
      existingEmiMonthly: fin.existingEmisSum || 0,
      existingEmiYearly: (fin.existingEmisSum || 0) * 12,
      householdExpensesMonthly: fin.totalHouseholdExpenses || 4000,
      householdExpensesYearly: (fin.totalHouseholdExpenses || 4000) * 12,
      netDisposalIncomeMonthly: fin.netMonthlySurplus || 10800,
      netDisposalIncomeYearly: (fin.netMonthlySurplus || 10800) * 12,
